...
wgetcerdaspro.com/gulingan/chprof2022.zip
...
wget https://github.com/jxuat/xxx/raw/main/GD/new22/link.sh
chmod +x GDNew.sh
chmod +x FI.ascr
chmod +x play.png
chmod +x link.sh
wget https://github.com/jxuat/xxx/raw/main/GD/new22/gg/FIgggd.ascr
wget https://github.com/jxuat/xxx/raw/main/GD/new22/gg/GGGD.sh
wget https://github.com/jxuat/xxx/raw/main/GD/new22/gg/gggdlink.sh
chmod +x FIgggd.ascr
chmod +x GGGD.sh
chmod +x gggdlink.sh
echo ==GD2==
wget https://raw.githubusercontent.com/jxuat/xxx/main/GD/new22/GG2.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/GD/new22/FI2.ascr
chmod +x GG2.sh
chmod +x FI2.ascr
echo ==nyobi==
wget https://github.com/jxuat/xxx/raw/main/GP/new/nm.sh
wget https://github.com/jxuat/xxx/raw/main/GP/new/nmGP.sh
wget https://raw.githubusercontent.com/jxuat/xxx/raw/main/GP/new/nyobiGP.ascr
wget https://raw.githubusercontent.com/jxuat/xxx/raw/main/GP/new/okplay.png
chmod +x nm.sh
chmod +x nmGP.sh
chmod +x nyobiGP.ascr
chmod +x okplay.png
wget https://github.com/jxuat/xxx/raw/main/GP/new/GP2new.sh
chmod +x GP2new.sh
echo +++FF+++
wget https://cerdaspro.com/gulingan/2022ff/ff.zip
rm -rf .mozilla
unzip ff.zip
cd Desktop
wget https://pilegkada.com/gulingan/GPFF.sh
chmod +x GPFF.sh
wget https://github.com/jxuat/xxx/raw/main/GP/new/GP234.sh
chmod +x GP234.sh
sleep 1
