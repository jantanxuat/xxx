...
mkdir Desktop
cd Desktop
wget https://raw.githubusercontent.com/jxuat/xxx/main/ff.sh
chmod +x ff.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/expert.sh
chmod +x expert.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/85ideas.sh
chmod +x 85ideas.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/85.sh
chmod +x 85.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/nicks.sh
chmod +x nicks.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/drive.sh
chmod +x drive.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/tek.sh
chmod +x tek.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/ext.sh
chmod +x ext.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/allsov.sh
chmod +x allsov.sh
wget https://raw.githubusercontent.com/jxuat/xxx/main/god.sh
chmod +x god.sh
sleep 1
cd /etc
mv hosts hosts.bak
